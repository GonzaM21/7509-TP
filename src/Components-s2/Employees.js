                    ...
                    <ExpansionPanel square expanded={false}>
                        <ExpansionPanelSummary>
                            <div className="column" style={{flexBasis: '24%'}}>
                                <Typography className="heading" onClick={this.sortname} style={{textAlign:"left"}}><b>Nombre</b></Typography>
                            </div>
                            <div className="column" style={{flexBasis: '24.0%'}}>
                                <Typography className="heading" onClick={this.sortarea} style={{textAlign:"left"}}><b>Area</b></Typography>
                            </div>
                            <div className="column" style={{flexBasis: '25.0%'}}>
                                <Typography className="heading"  onClick={this.sortsalary} style={{textAlign:"left"}}><b>Salario</b></Typography>
                            </div>
                            <div className="column" style={{flexBasis: '25.0%'}}>
                                <Typography className="heading" onClick={this.sortprogress} style={{textAlign:"center"}}><b>Progreso</b></Typography>
                            </div>
                        </ExpansionPanelSummary>
                    </ExpansionPanel>
            </div>
